...
--
-- Host: localhost:3306
-- Czas generowania: 19 Paź 2016, 14:54
...
CREATE TABLE `books` (
  ...
  `book_publication_date` smallint(6) NOT NULL,
  ...
  `book_cover` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Struktura tabeli dla tabeli `bookshelf_requests`
--

CREATE TABLE `bookshelf_requests` (
  `bookshelf_request_id` int(10) UNSIGNED NOT NULL,
  ...
  `bookshelf_request_closing_time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `bookshelf_request_votes`
--

CREATE TABLE `bookshelf_request_votes` (
  `bookshelf_request_id` int(10) UNSIGNED NOT NULL,
  `bookshelf_request_approved` tinyint(1) NOT NULL,
...
--
-- Indexes for table `bookshelf_requests`
--
ALTER TABLE `bookshelf_requests`
  ADD PRIMARY KEY (`bookshelf_request_id`);

--
-- Indexes for table `bookshelf_request_votes`
--
ALTER TABLE `bookshelf_request_votes`
  ADD UNIQUE KEY `bookshelf_request_id_2` (`bookshelf_request_id`,`user_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `bookshelf_request_id` (`bookshelf_request_id`);
...
--
-- AUTO_INCREMENT dla tabeli `bookshelf_requests`
--
ALTER TABLE `bookshelf_requests`
  MODIFY `bookshelf_request_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT dla tabeli `bookshelves`
--
ALTER TABLE `bookshelves`
  MODIFY `bookshelf_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT dla tabeli `borrowed_books`
--
ALTER TABLE `borrowed_books`
  MODIFY `borrow_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
-- Ograniczenia dla tabeli `bookshelf_request_votes`
--
ALTER TABLE `bookshelf_request_votes`
  ADD CONSTRAINT `bookshelf_request_votes_ibfk_1` FOREIGN KEY (`bookshelf_request_id`) REFERENCES `bookshelf_requests` (`bookshelf_request_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `bookshelf_request_votes_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
